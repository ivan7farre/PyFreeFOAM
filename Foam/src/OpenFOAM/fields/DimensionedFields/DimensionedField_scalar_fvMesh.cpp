...
%ignore Foam::DimensionedField< Foam::scalar, Foam::fvMesh >::component;
%ignore Foam::DimensionedField< Foam::scalar, Foam::fvMesh >::T;

%ignore Foam::DimensionedField< Foam::scalar, Foam::fvMesh >::typeName;
