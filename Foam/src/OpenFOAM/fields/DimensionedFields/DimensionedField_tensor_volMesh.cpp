...
//---------------------------------------------------------------------------
#ifndef DimensionedField_tensor_volMesh_cpp
#define DimensionedField_tensor_volMesh_cpp


//---------------------------------------------------------------------------
%module "Foam.src.OpenFOAM.fields.DimensionedFields.DimensionedField_tensor_volMesh";
%{
  #include "Foam/src/OpenFOAM/fields/DimensionedFields/DimensionedField_tensor_volMesh.hh"
%}
...
DIMENSIONED_FIELD_VOLMESH_TYPEMAP( tensor );
