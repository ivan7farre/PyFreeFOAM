...
//---------------------------------------------------------------------------
#ifndef List_symmTensor_i
#define List_symmTensor_i
...
%import "Foam/src/OpenFOAM/containers/Lists/UList/UList_symmTensor.i"

%template( List_symmTensor ) Foam::List< Foam::symmTensor >; 

%extend Foam::List< Foam::symmTensor > COMMON_EXTENDS;
