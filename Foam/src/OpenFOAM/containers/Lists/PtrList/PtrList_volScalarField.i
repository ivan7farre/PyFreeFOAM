...
//---------------------------------------------------------------------------
#ifndef PtrList_volScalarField_i
#define PtrList_volScalarField_i


//---------------------------------------------------------------------------
%module "Foam.src.OpenFOAM.containers.Lists.PtrList.PtrList_volScalarField";
%{
  #include "Foam/src/OpenFOAM/containers/Lists/PtrList/PtrList_volScalarField.hh"
%}
...
//---------------------------------------------------------------------------
%extend Foam::PtrList< Foam::volScalarField >
{
  Foam::PtrList< Foam::volScalarField >( const Foam::label s )
  {
    return new Foam::PtrList< Foam::volScalarField >( s );
  }
}
