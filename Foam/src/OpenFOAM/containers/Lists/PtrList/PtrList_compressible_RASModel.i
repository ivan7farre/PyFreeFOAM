...
%{
  #include "Foam/src/OpenFOAM/containers/Lists/PtrList/PtrList_compressible_RASModel.hh"
%}
...
#define PtrList_compressible_RASModel_i
#endif


//---------------------------------------------------------------------------
#ifndef PtrList_compressible_RASModel_i
#define PtrList_compressible_RASModel_i


//---------------------------------------------------------------------------
%import "Foam/src/OpenFOAM/fields/tmp/autoPtr_compressible_RASModel.i"
